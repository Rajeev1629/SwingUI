...
public class Tabbedpane extends JPanel {
	static JFrame f = new JFrame("Opteamix BDD Framework");
	...
	public Tabbedpane() {
		...
		tabbedPane.addTab("Feature Selection", icon, panel3,
		...
		JButton create = new JButton("Create JAR");
		...
		JButton open = new JButton("Configuration");
		...
		JButton edit = new JButton("Edit Properties");
		...
		tabbedPane.addTab("Create Feature File", icon, panel2,
